...
For post-query filtering, uncomment line 59-64 in Main.java. In addition, modify k in line 12 to k/p where p is the probability of passesFiltering() being true for an randomly selected point. In line 67, modify pq to pq2.
